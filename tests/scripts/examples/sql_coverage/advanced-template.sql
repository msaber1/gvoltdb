...
---- SELECT * FROM @fromtables Q34    WHERE CASE WHEN Q34._variable[#arg @columntype] _cmp @comparableconstant      THEN Q34._variable[#numone @columntype]     ELSE Q34._variable[#numone @columntype] * 10 END _cmp @comparableconstant + 10
...
---- SELECT _variable[#arg @comparabletype] Q36, CASE WHEN   A._variable[#arg @columntype] _cmp @comparableconstant THEN   A._variable[#numone @columntype]     ELSE   A._variable[#numone @columntype] * 10 END FROM @fromtables WHERE @columnpredicate
---- SELECT _variable[#arg @comparabletype] Q37, CASE WHEN   A._variable[#arg @columntype] _cmp @comparableconstant THEN   A._variable[#numone @columntype]                                                  END FROM @fromtables WHERE @columnpredicate
---- --- CASE WHEN like DECODE
---- SELECT * FROM @fromtables Q38    WHERE CASE      Q38._variable[#arg @columntype] WHEN @comparableconstant      THEN Q38._variable[#numone @columntype] * 2 ELSE Q38._variable[#numone @columntype] * 10 END _cmp @comparableconstant + 10
