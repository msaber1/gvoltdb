...
CREATE INDEX COL_F_TREE3 ON F (F_D3);
CREATE INDEX COL_F_TREE4 ON F (F_D3, F_D2);
CREATE INDEX EXPR_F_TREE1 ON F (F_D1 + F_D2);
CREATE INDEX EXPR_F_TREE2 ON F (ABS(F_D1), F_D2 - F_D3);
CREATE INDEX EXPR_F_TREE3 ON F (ABS(F_D3));
CREATE INDEX EXPR_F_TREE4 ON F (ABS(F_D3), F_D2);
...
CREATE INDEX COL_RF_TREE3 ON RF (F_D3);
CREATE INDEX COL_RF_TREE4 ON RF (F_D3, F_D2);
CREATE UNIQUE INDEX EXPR_RF_TREE1 ON RF (F_D1 + F_D2);
CREATE INDEX EPXR_RF_TREE2 ON RF (ABS(F_D1), F_D2 - F_D3);
CREATE INDEX EXPR_RF_TREE3 ON RF (ABS(F_D3));
CREATE INDEX EXPR_RF_TREE4 ON RF (ABS(F_D3), F_D2);
CREATE INDEX COL_RF_HASH ON RF (F_VAL3);

-- F2 and RF2 are minor variations of F and RF that tweak
-- their TREE3 indexes to make them less desirable for some edge
-- cases, where a filter optimization gets pitted against a
-- grouping optimization.
-- Making TREE3 less attractive by the current cost algorithm
-- avoids cases where TREE4 is actually optimal but TREE3 seems
-- to cost less and gets chosen.
-- The real solution would be SOME kind of smarter cost model.
CREATE TABLE F2 (
	F2_PKEY INTEGER NOT NULL,
	F2_D1   INTEGER NOT NULL,
	F2_D2   INTEGER NOT NULL,
	F2_D3   INTEGER NOT NULL,
	F2_VAL1 INTEGER NOT NULL,
	F2_VAL2 INTEGER NOT NULL,
	F2_VAL3 INTEGER NOT NULL,
	PRIMARY KEY (F2_PKEY)
);

PARTITION TABLE F2 ON COLUMN F2_PKEY;

CREATE INDEX COL_F2_TREE1 ON F2 (F2_D1);
CREATE INDEX COL_F2_TREE2 ON F2 (F2_VAL1, F2_VAL2);
CREATE INDEX COL_F2_TREE3 ON F2 (F2_D3, F2_VAL3);
CREATE INDEX COL_F2_TREE4 ON F2 (F2_D3, F2_D2);
CREATE INDEX EXPR_F2_TREE1 ON F2 (F2_D1 + F2_D2);
CREATE INDEX EXPR_F2_TREE2 ON F2 (ABS(F2_D1), F2_D2 - F2_D3);
CREATE INDEX EXPR_F2_TREE3 ON F2 (ABS(F2_D3), F2_VAL3);
CREATE INDEX EXPR_F2_TREE4 ON F2 (ABS(F2_D3), F2_D2);
...
CREATE INDEX COL_RF2_TREE1 ON RF2 (F2_D1);
CREATE INDEX COL_RF2_TREE2 ON RF2 (F2_VAL1, F2_VAL2);
CREATE INDEX COL_RF2_TREE3 ON RF2 (F2_D3, F2_VAL3);
CREATE INDEX COL_RF2_TREE4 ON RF2 (F2_D3, F2_D2);
CREATE UNIQUE INDEX EXPR_RF2_TREE1 ON RF2 (F2_D1 + F2_D2);
CREATE INDEX EPXR_RF2_TREE2 ON RF2 (ABS(F2_D1), F2_D2 - F2_D3);
CREATE INDEX EXPR_RF2_TREE3 ON RF2 (ABS(F2_D3), F2_VAL3);
CREATE INDEX EXPR_RF2_TREE4 ON RF2 (ABS(F2_D3), F2_D2);
CREATE INDEX COL_RF2_HASH ON RF2 (F2_VAL3);
