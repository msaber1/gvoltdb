...
// Enable to debug.
//#define TRUNCATE_ACTION_DEBUGDUMP(stage) debugDump(stage)
#ifndef TRUNCATE_ACTION_DEBUGDUMP
#define TRUNCATE_ACTION_DEBUGDUMP(stage)
#endif
...
public:
    ...
    {
        TRUNCATE_ACTION_DEBUGDUMP("ctor ");
    }
...
private:
     ...
     */
    virtual void undo() {
        TRUNCATE_ACTION_DEBUGDUMP("undo ");
    ...
    virtual void release() {
        ...
        TRUNCATE_ACTION_DEBUGDUMP("rels ");
