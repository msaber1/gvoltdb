...
#ifndef INDEXTABLEUNDOUPDATEACTION_H
#define INDEXTABLEUNDOUPDATEACTION_H

#include "common/UndoAction.h"
#include "common/TupleSchema.h"
#include "common/Pool.hpp"
#include "common/tabletuple.h"
#include "storage/IndexBasedPersistentTable.h"


namespace voltdb {

    class IndexTableUndoUpdateAction: public voltdb::UndoAction {
    public:

        inline IndexTableUndoUpdateAction(TableTuple &oldTuple,
