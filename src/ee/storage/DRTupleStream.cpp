                                  ...
                                  DRRecordType type)
{
    ...
    tupleMaxLength = computeOffsets(type, tuple, rowHeaderSz, rowMetadataSz, interestingColumns) + TXN_RECORD_HEADER_SIZE;
    ...
    writeRowTuple(tuple, rowHeaderSz, rowMetadataSz, interestingColumns, io);
...
size_t DRTupleStream::appendUpdateRecord(int64_t lastCommittedSpHandle,
    ...
    maxLength += computeOffsets(type, oldTuple, oldRowHeaderSz, oldRowMetadataSz, oldRowInterestingColumns);
    ...
    maxLength += computeOffsets(type, newTuple, newRowHeaderSz, newRowMetadataSz, dummyInterestingColumns);
    ...
    writeRowTuple(oldTuple, oldRowHeaderSz, oldRowMetadataSz, oldRowInterestingColumns, io);
    writeRowTuple(newTuple, newRowHeaderSz, newRowMetadataSz, NULL, io);
