...
ExpressionUtil::functionFactory(int functionId, const std::vector<AbstractExpression*>* arguments) {
    ...
    if (nArgs == 1) {
        ...
        case FUNC_TO_TIMESTAMP_MICROSECOND:
            ...
            break;
        case FUNC_VOLT_TRUNCATE_YEAR:
            ret = new UnaryFunctionExpression<FUNC_VOLT_TRUNCATE_YEAR>((*arguments)[0]);
            break;
        case FUNC_VOLT_TRUNCATE_QUARTER:
            ret = new UnaryFunctionExpression<FUNC_VOLT_TRUNCATE_QUARTER>((*arguments)[0]);
            break;
        case FUNC_VOLT_TRUNCATE_MONTH:
            ret = new UnaryFunctionExpression<FUNC_VOLT_TRUNCATE_MONTH>((*arguments)[0]);
            break;
        case FUNC_VOLT_TRUNCATE_DAY:
            ret = new UnaryFunctionExpression<FUNC_VOLT_TRUNCATE_DAY>((*arguments)[0]);
            break;
        case FUNC_VOLT_TRUNCATE_HOUR:
            ret = new UnaryFunctionExpression<FUNC_VOLT_TRUNCATE_HOUR>((*arguments)[0]);
            break;
        case FUNC_VOLT_TRUNCATE_MINUTE:
            ret = new UnaryFunctionExpression<FUNC_VOLT_TRUNCATE_MINUTE>((*arguments)[0]);
            break;
        case FUNC_VOLT_TRUNCATE_SECOND:
            ret = new UnaryFunctionExpression<FUNC_VOLT_TRUNCATE_SECOND>((*arguments)[0]);
            break;
        case FUNC_VOLT_TRUNCATE_MILLISECOND:
            ret = new UnaryFunctionExpression<FUNC_VOLT_TRUNCATE_MILLISECOND>((*arguments)[0]);
            break;
        case FUNC_VOLT_TRUNCATE_MICROSECOND:
            ret = new UnaryFunctionExpression<FUNC_VOLT_TRUNCATE_MICROSECOND>((*arguments)[0]);
            break;
