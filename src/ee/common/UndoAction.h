...
public:
    ...
    inline void* operator new(std::size_t size, UndoQuantum &pooler) throw(); // implemeted in UndoQuantum.h
    static void operator delete(void *pMemory, UndoQuantum &pooler) throw() { /* does nothing on failed allocate */ }
