...
public abstract class AbstractJoinPlanNode extends AbstractPlanNode {
    ...
    public void toJSONString(JSONStringer stringer) throws JSONException
    {
        ...
        stringer.key(Members.PRE_JOIN_PREDICATE.name()).object(m_preJoinPredicate);
        stringer.key(Members.JOIN_PREDICATE.name()).object(m_joinPredicate);
        stringer.key(Members.WHERE_PREDICATE.name()).object(m_wherePredicate);
