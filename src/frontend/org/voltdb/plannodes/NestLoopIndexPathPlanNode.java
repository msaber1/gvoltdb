...
/*/
 * Sigmod Demo
 * Class created from NestLookIndexPlanNode
 * 
 */
...
public class NestLoopIndexPathPlanNode extends AbstractJoinPlanNode {

	
    public NestLoopIndexPathPlanNode() {
        super();
    }

    @Override
    public PlanNodeType getPlanNodeType() {
        return PlanNodeType.NESTLOOPINDEXPATH;
    }
    ...
    protected String explainPlanForNode(String indent) {
        return "NESTLOOPPATH " + this.m_joinType.toString() + " JOIN" +
