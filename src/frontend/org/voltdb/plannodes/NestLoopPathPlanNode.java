...
public class NestLoopPathPlanNode extends AbstractJoinPlanNode {

    public NestLoopPathPlanNode() {
        super();
    }

    @Override
    public PlanNodeType getPlanNodeType() {
        return PlanNodeType.NESTLOOPPATH;
    }
    ...
    protected String explainPlanForNode(String indent) {
        return "NEST LOOP PATH " + this.m_joinType.toString() + " JOIN" +
