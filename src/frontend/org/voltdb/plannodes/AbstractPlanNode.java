...
public abstract class AbstractPlanNode implements JSONString, Comparable<AbstractPlanNode> {
    ...
    protected List<AbstractPlanNode> m_children = new ArrayList<>(2); // usually 1 or 2
    protected List<AbstractPlanNode> m_parents = new ArrayList<>(1);
    ...
    public ArrayList<AbstractPlanNode> findAllNodesOfType(PlanNodeType type) {
        HashSet<AbstractPlanNode> visited = new HashSet<>(); // will grow
        ArrayList<AbstractPlanNode> collected = new ArrayList<>(); // will grow
    ...
    final public Collection<AbstractExpression> findAllSubquerySubexpressions() {
        Set<AbstractExpression> collected = new HashSet<>(); // will grow
    ...
    public int compareTo(AbstractPlanNode other) {
        ...
        // compare child nodes
        HashMap<Integer, AbstractPlanNode> nodesById = new HashMap<>(m_children.size());
        for (AbstractPlanNode node : m_children) {
    ...
    public ArrayList<AbstractScanPlanNode> getScanNodeList () {
        HashSet<AbstractPlanNode> visited = new HashSet<>(); // will grow
        ArrayList<AbstractScanPlanNode> collected = new ArrayList<>(); // will grow
