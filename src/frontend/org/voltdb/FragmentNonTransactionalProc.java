 ...
 * but the catalog procedure advertises it as read-only and it
 * implicitly states that it won't read from any tables. This would
 * allow transaction management some flexibility in scheduling it.
 *
 */
public class FragmentNonTransactionalProc extends FragmentWriteProc {
