...
public class PlanAssembler {
    ...
    public CompiledPlan getBestCostPlan(AbstractParsedStmt parsedStmt, boolean coordinateResult) {
        ...
        if (parsedStmt instanceof ParsedSelectStmt && ((ParsedSelectStmt)parsedStmt).m_having != null) {
            subqueryExprs.addAll(
                    ((ParsedSelectStmt)parsedStmt).m_having.findAllSubexpressionsOfType(ExpressionType.SUBQUERY));
        }
        ...
        if (hasSubquery && retval != null) {
            ...
            boolean hasLimitOrOffset =
                    ((fromSubqueryResult != null) && fromSubqueryResult.m_hasLimitOrOffset) ||
                     (exprSubqueryResult != null) && exprSubqueryResult.m_hasLimitOrOffset));
