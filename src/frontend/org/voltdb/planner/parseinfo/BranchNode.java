...
public class BranchNode extends JoinNode {
    ...
    public void analyzeJoinExpressions(List<AbstractExpression> noneList, int stmtScanCount) {
        ...
        Collection<AbstractExpression> joinExprList = ExpressionUtil.uncombineAny(getJoinExpression());
        Collection<AbstractExpression> whereExprList = ExpressionUtil.uncombineAny(getWhereExpression());
