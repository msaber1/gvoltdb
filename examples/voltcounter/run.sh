...
function srccompile() {
    mkdir -p obj
    javac -g -target 1.6 -source 1.6 -classpath $APPCLASSPATH -d obj \
        src/voltcounter/*.java \
        src/voltcounter/procedures/*.java
...
function async-benchmark-help() {
    srccompile
    java -classpath obj:$APPCLASSPATH:obj voltcounter.AsyncBenchmark --help
}
