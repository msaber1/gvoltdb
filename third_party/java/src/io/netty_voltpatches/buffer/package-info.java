 ...
 * {@link io.netty_voltpatches.buffer.ByteBuf}, has been designed from ground
 ...
 * <h3>Extensibility</h3>
 *
 * {@link io.netty_voltpatches.buffer.ByteBuf} has rich set of operations
 * optimized for rapid protocol implementation.  For example,
 * {@link io.netty_voltpatches.buffer.ByteBuf} provides various operations
 ...
 * {@link io.netty_voltpatches.buffer.ByteBuf} interface rather than
 ...
 * </pre>
 * By contrast, {@link io.netty_voltpatches.buffer.ByteBuf} does not have such
 ...
 * {@link io.netty_voltpatches.buffer.ByteBuf} is a very thin wrapper of a
