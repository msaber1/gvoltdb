 ...
 * under the License.
 */
package io.netty_voltpatches.handler.codec.string;

import io.netty_voltpatches.buffer.ByteBuf;
import io.netty_voltpatches.channel.ChannelHandler.Sharable;
import io.netty_voltpatches.channel.ChannelHandlerContext;
import io.netty_voltpatches.channel.ChannelPipeline;
import io.netty_voltpatches.handler.codec.ByteToMessageDecoder;
import io.netty_voltpatches.handler.codec.DelimiterBasedFrameDecoder;
import io.netty_voltpatches.handler.codec.LineBasedFrameDecoder;
import io.netty_voltpatches.handler.codec.MessageToMessageDecoder;
