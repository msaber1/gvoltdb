 ...
 * under the License.
 */
package io.netty_voltpatches.handler.codec.serialization;

import io.netty_voltpatches.buffer.ByteBuf;
import io.netty_voltpatches.buffer.ByteBufOutputStream;
import io.netty_voltpatches.channel.ChannelHandlerContext;
import io.netty_voltpatches.handler.codec.MessageToByteEncoder;
