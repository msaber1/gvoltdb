...
public final class ResourceLeakDetector<T> {
    ...
    static {
        final boolean DISABLED = SystemPropertyUtil.getBoolean("io.netty_voltpatches.noResourceLeakDetection", false);
        logger.debug("-Dio.netty_voltpatches.noResourceLeakDetection: {}", DISABLED);
        disabled = DISABLED;
    }
